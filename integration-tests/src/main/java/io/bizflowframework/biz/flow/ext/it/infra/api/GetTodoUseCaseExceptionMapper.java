...
import io.bizflowframework.biz.flow.ext.it.domain.usecase.GetTodoBizQueryUseCaseException;
...
@Provider
public class GetTodoUseCaseExceptionMapper implements ExceptionMapper<GetTodoBizQueryUseCaseException> {
    ...
    public Response toResponse(final GetTodoBizQueryUseCaseException exception) {
