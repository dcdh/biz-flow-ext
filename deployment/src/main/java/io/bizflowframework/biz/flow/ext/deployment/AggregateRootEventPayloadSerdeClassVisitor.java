...
public final class AggregateRootEventPayloadSerdeClassVisitor extends ClassVisitor {
    ...
    public AggregateRootEventPayloadSerdeClassVisitor(final ClassVisitor classVisitor) {
    ...
    public void visit(final int version, final int access, final String name, final String signature, final String superName, final String[] interfaces) {
        ...
        this.aggregateRoot = new ClassTypeParameter(types[0]);
        this.aggregateRootEventPayload = new ClassTypeParameter(types[1]);
