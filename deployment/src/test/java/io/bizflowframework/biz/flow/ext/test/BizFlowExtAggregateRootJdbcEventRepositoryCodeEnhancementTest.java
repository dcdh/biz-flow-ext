...
public class BizFlowExtAggregateRootJdbcEventRepositoryCodeEnhancementTest {
    ...
    @Test
    public void shouldLoadAggregateRootJdbcEventRepositoryEnhanced() {
        // Given
        try (final Connection connection = dataSource.getConnection();
             final PreparedStatement insertFixturePreparedStatement = connection.prepareStatement(
                     ...
                     "VALUES (?, ?, ?, ?, ?, to_json(?::json))")) {
            insertFixturePreparedStatement.setString(1, "shouldLoadAggregateRootJdbcEventRepositoryEnhanced");
        ...
        // When && Then
        assertThatCode(() -> todoAggregateRootRepository.load(new TodoId("shouldLoadAggregateRootJdbcEventRepositoryEnhanced")))
