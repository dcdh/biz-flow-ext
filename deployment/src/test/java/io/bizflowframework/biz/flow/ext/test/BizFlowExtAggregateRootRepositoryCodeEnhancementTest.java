...
public class BizFlowExtAggregateRootRepositoryCodeEnhancementTest {
    ...
    @Test
    public void shouldLoadAggregateRootEnhanced() {
        // Given
        try (final Connection connection = dataSource.getConnection();
             final PreparedStatement insertFixturePreparedStatement = connection.prepareStatement(
                     ...
                     "VALUES (?, ?, ?, ?, ?, to_json(?::json))")) {
            insertFixturePreparedStatement.setString(1, "shouldLoadAggregateRootEnhanced");
        ...
        // When && Then
        assertThatCode(() -> todoAggregateRootRepository.load(new TodoId("shouldLoadAggregateRootEnhanced")))
